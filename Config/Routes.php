...
$mdm = model("App\Modules\Sgd\Models\Sgd_Modules");
$mdcxm = model("App\Modules\Sgd\Models\Sgd_Clients_Modules");
$module = 'sgd';
...
if ($cxm == "authorized") {
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Sgd::index');
						$subroutes->add('/home', 'Sgd::index');
						$subroutes->add('home/(:any)', 'Sgd::home/$1');
		...
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Sgd::denied');
						$subroutes->add('(:any)', 'Sgd::denied');
				}
		);
}
}
