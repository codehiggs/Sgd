...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-08-21 14:20:51
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Controllers\_Series.php]
...
class Series extends ModuleController {
	...
	//						"sgd-series-edit-all",
	//						"sgd-series-delete",
	//						"sgd-series-delete-all",

    public function __construct() {
       parent::__construct();
       $this->prefix = 'sgd-series';
    ...
    public function index() {
        $url = base_url('sgd/series/home/' . lpk());
    ...
    public function home(string $rnd) {
        ...
        $this->component = $this->views . '\Series\Home';
    ...
    public function view(string $oid) {
        ...
        $this->component = $this->views . '\Series\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd) {
        ...
        $this->component = $this->views . '\Series\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd) {
        ...
        $this->component = $this->views . '\Series\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid) {
        ...
        $this->component = $this->views . '\Series\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid) {
        ...
        $this->component = $this->views . '\Series\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
