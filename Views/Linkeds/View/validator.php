...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Linkeds\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("linked","trim|required");
//$f->set_ValidationRule("file","trim|required");
//$f->set_ValidationRule("subserie","trim|required");
//$f->set_ValidationRule("metatag","trim|required");
