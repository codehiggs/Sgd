...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-08-21 14:21:03
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Subseries\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sgd/api/subseries/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' =>ICON_ADD,'text'=>lang('App.Create'), 'href' => '/sgd/subseries/create/'.lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'subserie' => array('text' => lang('App.subserie'), 'class' => 'text-center'),
        'serie' => array('text' => lang('App.serie'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
	 "title" => lang('Subseries.list-title'),
	 "header-back" => $back,
	 "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Subseries.list-title'), "message" => lang('Subseries.list-description')),
	 "content" => $table,
));
echo($card);
?>
