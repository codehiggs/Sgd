...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sgd/api/metatags/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' =>ICON_ADD,'text'=>lang('App.Create'), 'href' => '/sgd/metatags/create/'.lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
	 "title" => lang('Metatags.list-title'),
	 "header-back" => $back,
	 "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Metatags.list-title'), "message" => lang('Metatags.list-description')),
	 "content" => $table,
));
echo($card);
?>
