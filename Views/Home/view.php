...
$server = service("server");
	$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Sgd') / 102400), 6);$card = $bootstrap->get_Card("card-view-Sgd", array(
		"class" => "mb-3",
		"title" => lang("Sgd.module") . "<span class='text-muted'>v{$version}</span>",
		"header-back" => "/",
