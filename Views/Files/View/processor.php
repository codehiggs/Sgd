...
$c = $bootstrap->get_Card('warning', array(
				...
				'footer-continue' => base_url("/sgd/files/view/{$d["file"]}/".lpk()),
				'voice' => "sgd/files-view-success-message.mp3",
		));
}else {
$c = $bootstrap->get_Card('success', array(
				...
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/sgd/files"),
				'voice' => "sgd/files-view-noexist-message.mp3",
		));
}
echo($c);
?>
