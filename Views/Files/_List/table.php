...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-08-21 14:20:17
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Files\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sgd/api/files/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' =>ICON_ADD,'text'=>lang('App.Create'), 'href' => '/sgd/files/create/'.lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        ...
        'size' => array('text' => lang('App.size'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
	 "title" => lang('Files.list-title'),
	 "header-back" => $back,
	 "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Files.list-title'), "message" => lang('Files.list-description')),
	 "content" => $table,
));
echo($card);
?>
